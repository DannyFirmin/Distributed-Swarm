...
package Vehicle_Task_Type is
   ...
   -- To remember the message I sent locally, nobody other than me will touch it
   -- It's here because I uses procedure to reduce duplicate code
   ...
   procedure Update_MyGlobes (My_Globe : in out Globes_I_Know; Multi_Globes : in out Boolean);
